...
# from register_zod_splits import register_zod_splits
from register_all_subset import register_all_zod_datasets
...
def main(args):
    ...
    register_kitti_splits()  # Register KITTI dataset
    # register_zod_splits()  # Register ZOD dataset
    # register_all_zod_datasets()  # Register test subset for quick testing
